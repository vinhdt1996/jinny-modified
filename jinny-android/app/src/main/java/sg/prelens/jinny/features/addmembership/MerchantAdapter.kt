...
//            Quyết định 2 item có data giống nhau hay không. Method này chỉ được gọi khi areContentsTheSame() = true.
            override fun areContentsTheSame(oldItem: Merchant, newItem: Merchant): Boolean =
                    oldItem == newItem
//            Quyết định 2 object có cùng đại diện cho 1 item hay không?
